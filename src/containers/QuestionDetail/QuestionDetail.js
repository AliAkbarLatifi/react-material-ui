...
const mock = { question: "Favourite hot beverage?", published_at: "2015-05-27T21:22:26.648000+00:00", url: "/questions/9", choices: [{"choice": "Apple Cider", "votes": 30, "url": "/questions/9/choices/67"}, {"choice": "Tea", "votes": 30, "url": "/questions/9/choices/65"}, {"choice": "Hot Chocolate", "votes": 21, "url": "/questions/9/choices/68"}, {"choice": "Coffee", "votes": 17, "url": "/questions/9/choices/66"}]};
...
function QuestionDetail({match, history}) {
    ...
    useEffect(()=>{
        QuestionDetailAPI.getDetail(apiUrl)
            .then((response) => {
              const questionDetail = response.data || mock;
              const res= {loading: false, questionDetail};
              setData({...data, ...res});
            });
